...
//	public function __construct( $content, $link = null, $timestamp, $twit, $twit_link, $twit_pic ) {
	public function __construct( $content, $tweet_id, $created_at, $screen_name, $name ) {
	...
	protected function construct_twit_avatar_links() {
		$this->twit_pic_bigger = sprintf( "http://api.twitter.com/1/users/profile_image/%s?size=bigger", $this->twit_uid );
		$this->twit_pic = sprintf( "http://api.twitter.com/1/users/profile_image/%s", $this->twit_uid );
	}

...
Tags: video thumbnail, video, thumbnail post, thumbnail, post, advanced, random, post thumbnail, excerpt thumbnail, more tag thumbnail, hpt, hpt_, hungred, hungred post thumbnail, frontpage, customize,random,upload,custom field
...
== Description ==
If you are looking for a thumbnail plugin, this is it.
...
This plugin is design for hungred.com and people who faced the same problem. Basically it can be break down into the following points
   ...
   3. People who are lazy to always have to upload thumbnail up their post
  ...
  12. Powerful.
  13. Provides the different mode for each post
  14. Provides thumbnail mode that may differ with front page
  15. Provides 7 different powerful mode
  16. Video Thumbnail
...
Question: Can i disable individual post thumbnail?
Answer: Yes, upon version 2.0.0 thumbnail can be disabled individually

Question: Can i resize individual post thumbnail
Answer: Yes, upon version 2.0.0 thumbnail can be resize individually

Question: Can i change individual post thumbnail display mode?
Answer: Yes, upon version 2.0.0 thumbnail mode can be change individually

Question: Can i change individual post thumbnail display mode/size for front page ONLY?
Answer: Yes, upon version 2.0.0 you can do that

Question: Can this plugin grab the first image of my post and set as thumbnail?
Answer: Yes, upon version 2.0.0 you can do that. A new mode is provided

Question: I used the first image mode to retrieve the first image as thumbnail but my post doesn't have any image!
Answer: Not too worry, the default image will be used instead.

Question: Your thumbnail doesn't work on localhost! But it work on my live server?
Answer: The plugin previously was tested on Hungred Dot Com test server. Upon 2.0.0, this thumbnail can also be tested on localhost

Question: Your plugin lag my Wordpress!
Answer: This is definitely not true. Whatever this plugin is doing are calculation and display using CSS. NO heavy work is being done in the plugin other than resizing on admin page. I won't want my website (Hungred Dot Com) to be slow!

Question: Can we adjust the images compression value for this plugin resize capability?
Answer: Nope

Question: Your plugin mess up my site! What happen?
Answer: basically the default setting here is for Hungred Dot Com, upon 2.0.0 you can disable the inline style (this only affect the styling other settings are still available) on the admin page and style it on your own CSS external script.

Question: What PHP does this plugin support?
Answer: This plugin was tested with PHP 5.1. But someone said it also worked with PHP4.x i won't said EVERY single function works on PHP4. Tell me what doesn't and i shall help if possible

Question: What File Permission does this plugin required?
Answer: The plugin image folder will required a permission of 755.
...
Answer: Yes, if setting is set to allow

Question: Do you preserve the original image?
...
Question: Who are suitable to use this plugin?
...
Question: Some post images doesn't show up on mode random/advance/smart?!
...
Question: Your plugin SUCKS!
Answer: Don't use it then. Its not like you have contributed ANYTHING. shoo~

Question: Can i change the location of wp-config folder in this plugin?
Answer: Yes. After version 2.1.0

Question: Can i change the location of the upload/thumbnail folder?
Answer: Yes. After version 2.1.0

Question: Why is there such a big changes on your plugin in version 2.0.0?
Answer: There was a kind soul who is willingly to contribute to this plugin development? And some people did help out on Hungred Dot Com by visiting our sponsors while others show appreciation.

== Screenshots ==
1. hungred-post-thumbnail-admin.jpg
2. hungred-post-thumbnail-new-panel.jpg
3. hungred-post-thumbnail-result.jpg
4. hungred-post-thumbnail-explanation.jpg
5. hungred-post-thumbnail-new-panel-explain.jpg
...
= 2.0.0 = 
* Update Pledge tag
* Update Thumbnail Admin Interface
* Update database structure
* Update readme.txt FAQ file
* Update display style of the post button
* Updated documentation
* Added option for classname in admin
* Added option for use inner style in admin
* Added id for each image tag
* Added customize image size for each post
* Added customize mode for each post
* Added disabled capability to each post
* Added retrieve first image as thumbnail method for both individual and global method
* Added enable/disable button on each post
* Added front page resize only option
* Added News Update
* Fixed localhost draft image cannot transfer to live image
* Fixed draft or live image overlapped problem on post page
* Fixed localhost upload image problem on admin page
* Improve the way inner style work - empty will remove that inner style from appearing
* Improve File Security
* Improve Data Structure
* Improve User Interface
* Optimize code

* Thanks to soccermylife.com for sponsoring this update!
= 2.1.0 = 
